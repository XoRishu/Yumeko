...
nations = """ Yumeko has bot access levels we call as *"Nation Levels"*
...
Owner has complete bot access, including bot adminship in chats Yumeko is at.
\n*Royals* - Have super user access, can gban, manage Nations lower than them and are admins in Yumeko.
\n*Sakuras* - Have access go globally ban users across Yumeko.
...
\n*Disclaimer*: The Nation levels in Yumeko are there for troubleshooting, support, banning potential scammers.
Report abuse or ask us more on these at [Eagle Union](https://t.me/Kaizuryu_Bot_Support).
"""
