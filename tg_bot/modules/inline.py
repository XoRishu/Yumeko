...
def inlineinfo(query: str, update: Update, context: CallbackContext) -> None:
    ...
    kb = InlineKeyboardMarkup([[InlineKeyboardButton(text="Report Error", url="https://t.me/Kaizuryu_Bot_Support"), InlineKeyboardButton(text="Search again", switch_inline_query_current_chat=".info ",)]])
...
def media_query(query: str, update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        kb = InlineKeyboardMarkup([[InlineKeyboardButton(text="Report error", url="t.me/Kaizuryu_Bot_Support"), InlineKeyboardButton(text="Search again", switch_inline_query_current_chat=".anilist ")]])
